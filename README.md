...
### วิธีที่ 1: Initialize จากโฟลเดอร์ที่ยังไม่ใช่ Git Repo

**ถ้าคุณมีโฟลเดอร์ที่ยังไม่ได้ init Git และต้องการดึงข้อมูลจาก GitHub:**

```powershell
# 1. เข้าไปยังโฟลเดอร์ของคุณ
cd C:\path\to\your\folder

# 2. Copy สคริปต์ init-from-github.ps1 มาที่โฟลเดอร์นี้

# 3. รันสคริปต์เพื่อ initialize และ pull จาก GitHub
...
# - เพิ่ม remote origin
# - fetch และ checkout branch จาก GitHub
```

> 📖 **ดูคู่มือ Initialize Repository:** [INIT-REPO-GUIDE.md](INIT-REPO-GUIDE.md)
> - การ initialize Git repository
> - การดึงข้อมูลจาก GitHub
> - การแก้ปัญหาเบื้องต้น

### วิธีที่ 2: Clone โปรเจคที่มีอยู่แล้ว
...
### วิธีที่ 3: เปลี่ยน Repository ปลายทาง
...
### สคริปต์เสริม
- **[init-from-github.ps1](init-from-github.ps1)** - Initialize Git repository จาก GitHub (สำหรับโฟลเดอร์ที่ยังไม่ใช่ Git repo)
- **[setup-repo.ps1](setup-repo.ps1)** - ตั้งค่าและเปลี่ยน Git repository (สำหรับ repo ที่มีอยู่แล้ว)
